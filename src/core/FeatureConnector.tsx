...
type FeatureEntry = IFeatureEntry<any, any, any, any, any>;

type FeatureLoader = () => Promise<FeatureEntry>;
...
function featureConnect<L extends IDictionary<FeatureLoader>>(loaders: L, preloader?: React.ReactChild):
  ...
  return <Props extends {[K in keyof L]: any}>(
    ...
    class FeatureConnector extends React.PureComponent<Omit<Props, keyof L>, IState> {
      ...
      private connectFeatureToStore: (entry: FeatureEntry) => void;
      ...
      private saveBundleToState: null | ((bundle: FeatureEntry, key: keyof any) => void) =
        (bundle, key) => {
          this.setState(state => ({
            ...state,
            bundles: {
